...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <a class="navbar-brand" href="#">Biodata Saya</a>
    ...
    <section id="home   " class="text-center py-5">
        <img src="{{ ('image/saya.jpg')}}" width="150" alt="Your name" class="rounded-circle">
        <h1>Muhammad irfansyah</h1>
        <p>Mahasiswa</p>
        <p>Hi, saya adalah Mahasiswa Politeknik Negeri Bengkalis. Prodi D4 RPL Jurusan Teknik informatika Saat ini sedang belajar Laravel di Lab Software Testing.
        </p>
    </section>
    ...
    <footer class="bg-primary text-white text-center py-3">
        Copyright 2023 @Muhammad irfansyah
    </footer>
